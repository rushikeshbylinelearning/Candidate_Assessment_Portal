/**
 * SSO audit logging — appends structured entries to backend/sso-audit.log.
 * Pattern mirrors: candidate-assessment-portal/backend/src/services/ssoLoginAuditService.js
 */
...
async function logAction(actionData) {
  ...
  try {
    ...
    console.error('[Assessment SSO AUDIT] Failed to write audit log:', error);
    console.log(`[Assessment SSO AUDIT] ${timestamp} - ${message}`);
  }
}
