...
/**
 * SSO Callback page — receives ?token=&user= from the backend redirect,
 * stores them, and sends the user to the HR dashboard.
 *
 * Pattern mirrors: hr-workflow-management/src/components/SsoCallback.tsx
 */
export default function SsoCallback() {
  ...
  useEffect(() => {
    ...
    // Surface any SSO error the backend forwarded via ?error=&message=
